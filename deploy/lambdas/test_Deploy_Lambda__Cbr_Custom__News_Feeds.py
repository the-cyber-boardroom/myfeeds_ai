...
class test_Deploy_Lambda__Cbr_Custom__News_Feeds(TestCase):
    ...
    def test_ecr_image_uri(self):
        with self.deploy_lambda as _:
            ...
            assert ecr_image_uri == f'654654216424.dkr.ecr.eu-west-1.amazonaws.com/osbot_flows:{version__cbr_custom_news_feeds}'
