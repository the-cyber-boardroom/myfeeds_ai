...
class test__int__Pipeline__Hacker_News__Create_Persona_Digest(TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.target_persona                = Schema__Persona__Types.EXEC__CEO
        cls.pipline_create_persona_digest = Pipeline__Hacker_News__Create_Persona_Digest(persona_type=cls.target_persona)
