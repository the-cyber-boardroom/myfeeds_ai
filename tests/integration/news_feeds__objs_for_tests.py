...
CBR_ATHENA__TEST__AWS_ACCOUNT_ID = '000011110000'

def setup_local_stack() -> Local_Stack:                          # todo: refator this to the OSBot_Local_Stack code base
    Temp_AWS_Credentials().set_vars()
    set_env('AWS_ACCOUNT_ID', CBR_ATHENA__TEST__AWS_ACCOUNT_ID)  # todo: fix the Temp_AWS_Credentials so that we don't need use this set_env
