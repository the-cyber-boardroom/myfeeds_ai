...
from myfeeds_ai.providers.cyber_security.docs_diniscruz_ai.routes.Routes__Docs_DinisCruz_Ai import ROUTES_PATHS__DOCS_DINISCRUZ_AI
...
class test_Data_Feeds__Fast_API(TestCase):
    ...
    def test_setup_routes(self):
        ...
        assert routes == sorted(['/',
                                 ...
                                 + ROUTES_PATHS__DOCS_DINISCRUZ_AI                     \
                                 + ROUTES_PATHS__OSS                                   \
                                 + ROUTES_PATHS__OWASP                                 )
