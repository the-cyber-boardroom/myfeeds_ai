...
from cbr_custom_data_feeds.config.Custom_News__Shared_Constants import S3_BUCKET_PREFIX__DATA_FEEDS, \
    S3_BUCKET_SUFFIX__HACKER_NEWS, S3_FILE_NAME__RAW__CONTENT, S3_FOLDER__ROOT_FOLDER__PUBLIC_DATA
...
class test_OSS__S3_DB(TestCase):
    ...
    def test_raw_data_save(self):
        with self.s3_db_oss as _:
            ...
            s3_key          = _.s3_key__for_path__oss_data(s3_path)
