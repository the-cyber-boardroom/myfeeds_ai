...
from myfeeds_ai.providers.cyber_security.owasp.llms.prompts.LLM__Prompt__Owasp__Top_10__Parse_Markdown import \
    LLM__Prompt__Owasp__Top_10__Parse_Markdown
...
class test_LLM__Prompt__Owasp__Top_10__Parse_Markdown(TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.category_markdown       = cls.owasp_files_top_10.file__category(cls.category).data()
    ...
    def test_llm_request(self):
        with self.prompt_extract_category as _:
            ...
            if llm_response:
                ...
                pprint(owasp_top_10_category.json())
