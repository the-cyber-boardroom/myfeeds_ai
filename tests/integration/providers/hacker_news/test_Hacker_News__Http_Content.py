...
class test_Hacker_News__Http_Content(TestCase):
    ...
    @patch('myfeeds_ai.providers.cyber_security.hacker_news.Hacker_News__Http_Content.Hacker_News__Http_Content.feed_data')
    ...
    # @patch('myfeeds_ai.providers.cyber_security.hacker_news.Hacker_News__Http_Content.Hacker_News__Http_Content.get_feed_data')
