...
class test__int__Flow__Hacker_News__7__Article__Step_4__Create_Text_Entities_Graphs(TestCase):
    ...
    def setUp(self):
        self.flow_llm_create_text_entities_graphs = Flow__Hacker_News__7__Article__Step_4__Create_Text_Entities_Graphs()
    ...
    def test_task__1__load_articles_to_process(self):
        with self.flow_llm_create_text_entities_graphs as _:
            ...
            assert _.articles_to_process      == _.file_articles_current.next_step__4__create_text_entities_graphs()
