...
from cbr_custom_data_feeds.data_feeds.Data__Feeds__Shared_Constants                                         import S3_FILE_NAME__RAW__CONTENT, S3_FILE_NAME__CONTENT
...
class OSS__S3_DB(Data_Feeds__S3_DB):
    ...
    def s3_path__content__now(self):
        return self.s3_key_generator.s3_path__now(file_id=S3_FILE_NAME__CONTENT)
