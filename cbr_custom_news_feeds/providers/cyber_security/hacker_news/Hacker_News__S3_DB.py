...
S3_FILE_NAME__RAW__FEED_XML    = 'feed_xml'
S3_FILE_NAME__RAW__FEED_DATA   = 'feed_data'
...
class Hacker_News__S3_DB(S3__DB_Base):
    ...
    def s3_folder__for_data(self):
        return self.s3_key_generator.s3_folder__for_area(area=Model__Hacker_News__Areas.DATA    )
    ...
    def s3_key__raw_data__feed_xml(self):
         return self.s3_key_generator.s3_key(area=Model__Hacker_News__Areas.RAW_DATA, file_id=S3_FILE_NAME__RAW__FEED_XML)
