...
from myfeeds_ai.providers.cyber_security.hacker_news.config.Config__Hacker_News     import FILE_ID__MGRAPH__TIMELINE__DIFF, FILE_ID__MGRAPH__TIMELINE
...
class Hacker_News__File__Timeline__Diff(Hacker_News__File):
    file_id               = FILE_ID__MGRAPH__TIMELINE__DIFF
    ...
    def file_name__feed_timeline_mgraph(self):
        return f"{FILE_ID__MGRAPH__TIMELINE}.{S3_Key__File_Extension.MGRAPH__JSON.value}"