...
from myfeeds_ai.providers.cyber_security.hacker_news.config.Config__Hacker_News                 import FILE_ID__ARTICLES__NEW
...
class Hacker_News__File__Articles__New(Hacker_News__File):
    ...
    # refactor this should not be needed when data_type is set
    def load(self):
