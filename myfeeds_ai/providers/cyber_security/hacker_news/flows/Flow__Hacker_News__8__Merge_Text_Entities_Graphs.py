...
from myfeeds_ai.providers.cyber_security.hacker_news.actions.Hacker_News__Article__Entities import \
    Hacker_News__Article__Entities
...
class Flow__Hacker_News__8__Merge_Text_Entities_Graphs(Type_Safe):
    ...
    def task__2__llm__merge_text_entities_graphs(self):
        ...
        for article in self.articles_to_process[0:FLOW__HACKER_NEWS__8__MAX__ARTICLES_TO_CREATE]:
            ...
            # mgraph_text_entities__description = article.path__file__text_entities__description__mgraph
            # mgraph_text_entities__title       = article.path__file__text_entities__title__mgraph
            pprint(article.path__file__text_entities__title__mgraph)
            pprint(mgraph_text_entities__title.path_now())
            pprint(mgraph_text_entities__title.exists())
            #article.next_step = Schema__Feed__Article__Step.STEP__4__CREATE__TEXT_ENTITIES_GRAPHS
