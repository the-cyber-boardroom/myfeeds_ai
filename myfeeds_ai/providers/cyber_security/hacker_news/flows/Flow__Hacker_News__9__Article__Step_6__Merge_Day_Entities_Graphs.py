...
from myfeeds_ai.providers.cyber_security.hacker_news.actions.Hacker_News__Text_Entities import \
    Hacker_News__Text_Entities
...
class Flow__Hacker_News__9__Article__Step_6__Merge_Day_Entities_Graphs(Type_Safe):
    ...
    def task__4__create_mgraph_png(self):
        ...
        # todo add task to update file_articles (i.e. move these articles to the next phase)
    ...
    def process_articles(self) -> Flow:
        with self as _:
            ...
            _.task__5__task__4__create_mgraph_png    ()
        return self.output
