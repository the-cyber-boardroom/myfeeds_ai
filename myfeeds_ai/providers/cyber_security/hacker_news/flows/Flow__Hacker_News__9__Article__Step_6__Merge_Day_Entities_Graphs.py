# todo: see if we still need this step since we now creating using the new_articles to get the target articles for the digest
#       namely are there users for this data (in the current workflow)
#       also this class was doing an "Hour Merge" (not an "Day Merge")
